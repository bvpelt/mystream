insert into author (id, username, bio)
values (1, 'g00glen00b', 'Administrator of this website') ,
    (2, 'john.doe', 'A person who prefers to stay anonymous');
insert into post (id, title, content, author_id, posted_at)
values (1, 'Welcome to this community',
        'This is a small introduction text to the wonderful community of postit. Just add new posts by opening the link at the left navigation. To view a post, you can click its title and post comments to it.',
...
insert into comment (id, content, author_id, post_id, posted_at)
values (1, 'This community looinsert into author (id, username, bio) values
...
insert into comment (id, content, author_id, post_id, posted_at) values
  ...
  (3, ''Sorry to see you go!'', 1, 2, ''2018-08-04 00:00:00'');ks interesting, it might be even better than Reddit!', 2,
